...
extern uint64 sys_trace(void); // newly added
extern uint64 sys_sysinfo(void); // newly added
...
[SYS_mkdir]   sys_mkdir,
[SYS_close]   sys_close,
[SYS_trace]   sys_trace, // newly added
[SYS_sysinfo] sys_sysinfo, // newly added
};

const char *syscall_names[] = { // 系统调用名称
[SYS_fork]    "fork",
[SYS_exit]    "exit",
[SYS_wait]    "wait",
[SYS_pipe]    "pipe",
